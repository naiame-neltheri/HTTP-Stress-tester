...
consumedLst = []
site_root = "site_root"
apiGatewayLive = "####/prod/uploadFileFromURL"
timeout = 30
pool_counter = 0
pool_counter_size = 0
...
if "__main__" in __name__:
    ...
    cnt = 0
    for i in range(0,30):
        connection_pool.append( pooling.MySQLConnectionPool(pool_name="pynative_pool"+str(i),pool_size=32,pool_reset_session=True,host='127.0.0.1',database='mangakor',user='root',password='Bojo123$%', auth_plugin='mysql_native_password') )
